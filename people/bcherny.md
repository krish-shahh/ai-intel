...
Boris Cherny is the creator and head of Claude Code, Anthropic's command-line coding agent. Before Anthropic he spent about five years at Meta as a principal engineer and wrote the book Programming TypeScript. In mid-2025 he briefly left Anthropic for the AI coding startup Cursor (Anysphere) but returned to Anthropic within roughly two weeks. As of 2026 he leads Claude Code at Anthropic.
...
- **2026-08-02** Running a live experiment where Claude Code has been rewriting the Claude Mac desktop app in Swift autonomously for 14-15 days; the model spawned its own Slack channel and posts screenshots every few minutes. At YC Startup School (one day after Opus 5 shipped) disclosed that deleting 80% of Claude Code's system prompt improved performance; undocumented flag `CLAUDE_CODE_SIMPLE=1` strips remaining prompts. [Daring Fireball](https://daringfireball.net/linked/2026/08/02/cherny-claude-swift) · [HN](https://news.ycombinator.com/item?id=49149800) · [YC Startup Library](https://www.ycombinator.com/library/UN-boris-cherny-building-claude-code)
