...
- Anthropic outage cadence: on Sept 3, ChatGPT, Claude, and Grok all hit errors within the same window, with Azure cloud issues implicated as a contributing factor; Claude's Opus 4.8 and Opus 5 lagged the other models back to baseline, full recovery by 12:38pm PT. Updates the watchlist item (previously "last incident Aug 31") with a new, multi-provider-correlated incident. [Axios](https://www.axios.com/2026/09/03/chatgpt-claude-grok-outages) (independent) · [The Register](https://www.theregister.com/ai-and-ml/2026/09/03/chatgpt-claude-and-grok-all-had-outages-at-the-same-time/5294322) (independent)
