...
- OpenAI has reportedly bought tens of thousands of Apple Mac minis and Mac Studios to run reinforcement learning and train computer-use agents, per The Information; Apple's unified memory design suits multi-step interface-navigation workloads, and the buying is said to be contributing to Mac supply shortages. Unconfirmed by OpenAI or Apple. [BusinessToday](https://www.businesstoday.in/technology/artificial-intelligence/story/openai-is-buying-thousands-of-apple-mac-minis-to-train-ai-agents-heres-whats-driving-the-move-552202-2026-08-31) · [TechBriefly](https://techbriefly.com/2026/08/31/openai-buys-apple-macs-for-ai-training/)
