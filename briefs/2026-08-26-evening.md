...
- [[nvidia]] gave its first on-record response to the Jetson Orin/Russian drone story: the modules are "consumer-grade products sold to students, developers and start-ups," not designed for military use and not sold directly to Russia, though the company admits it can't track resale. Sen. Warren shot back that if [[jensenhuang]] has time for a $1M Mar-a-Lago dinner, he has time to testify before Congress. [Benzinga](https://www.benzinga.com/markets/tech/26/08/61400006/elizabeth-warren-jensen-huang-one-million-mar-a-lago-nvidia-russian-drones)

## Other

- GitHub trending today: Anthropic's own community plugin marketplace mirror for [[claude-code]] (`anthropics/claude-plugins-community`) is surging, alongside a fan-made `andrej-karpathy-skills` CLAUDE.md guide sitting at 200k+ stars. It's not authored by [[karpathy]] himself and its provenance is unverified — worth a skeptical look, not an endorsement. [claude-plugins-community](https://github.com/anthropics/claude-plugins-community) · [andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills)
- Hacker News' Algolia API was blocked by network egress again this session; narrower community sourcing than usual tonight.
- [[nvidia]] reports fiscal Q2 earnings after close today (~20:30 UTC), the first real read on China H200 assumptions and Q3 guidance. [Kiplinger](https://www.kiplinger.com/investing/live/nvidia-earnings-live-updates-and-commentary-august-2026)
